...
private val bracePairs = arrayOf(
    BracePair(NuShellTypes.L_PAREN, NuShellTypes.R_PAREN, false),
    BracePair(NuShellTypes.L_BRACK, NuShellTypes.R_BRACK, false),
    BracePair(NuShellTypes.L_BRACE, NuShellTypes.R_BRACE, true)
)
