 ...
 * for any .nu script in the nu_scripts submodule.
 */
class NuLexerNuScriptsTest : LexerTestCase() {

    override fun createLexer() = NuLexer()

    override fun getDirPath() = "src/test/resources/nu_scripts"
    ...
    fun testAllNuScriptsLexWithoutErrors() {
        val scripts = collectNuScripts()
        assertTrue("No .nu scripts found in nu_scripts submodule", scripts.isNotEmpty())
